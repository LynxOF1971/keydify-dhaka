...
function renderAnalytics(root) {
  ...
  panel.append(button('Refresh totals', refresh), el('p', 'Visits count each storefront page opening (including refreshes), not unique people. Total ordered combines clicks on all WhatsApp and Messenger contact and order buttons. It measures chat-button clicks, not confirmed purchases. Studio, local tests and draft previews do not add visits. Totals begin when tracking is launched and are shared across keydify.com, www.keydify.com and the GitHub website.', 'analytics-note'));
